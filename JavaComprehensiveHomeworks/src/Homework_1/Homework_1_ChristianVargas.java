...
public class Homework_1_ChristianVargas {
	...
	public static void excercise_1_2(){
			...
			double numGrade = sc.nextDouble();		// Declare and set value numGrade
			
			char grade;
			
			if(numGrade >= 88 && numGrade <=100){	//testing numGrade on IfStatements
	            grade = 'A'; }
	...
	public static void excercise_1_3(){
		...
		double userFahrenheitDegrees = sc.nextDouble();		// Declare and set value variable
